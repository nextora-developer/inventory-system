                ...
                <div class="p-6">
                    ...
                    <form action="{{ route('stock.out.store') }}" method="POST" class="space-y-6">
                        ...
                        <div class="group">
                            ...
                            <input type="number" name="quantity" value="{{ old('quantity') }}" placeholder="e.g. 10"
                                class="w-full rounded-2xl border-2 border-slate-100 bg-slate-50 px-4 py-3.5 text-sm focus:border-rose-500 focus:bg-white focus:ring-4 focus:ring-rose-500/10">
                        </div>
                        ...
                        <div class="group">
                            ...
                            <textarea name="remark" rows="4" placeholder="e.g. Used for project / damaged items"
        ...
        <div class="xl:col-span-2">
            ...
            <div class="overflow-hidden rounded-3xl border border-slate-100 bg-white shadow-sm">
                ...
                <div class="border-b border-slate-100 p-4 md:p-6">
                    <h2 class="text-base font-bold text-slate-900 md:text-lg">Recent Stock Out</h2>
                    <p class="mt-1 text-xs text-slate-500 md:text-sm">Latest outgoing inventory records.</p>
                </div>
