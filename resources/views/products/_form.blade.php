...
<div class="space-y-8">
    ...
    <div class="grid grid-cols-1 gap-6 md:grid-cols-2 xl:grid-cols-4">
        ...
        {{-- Row 4 --}}
        {{-- Location --}}
        <div class="group md:col-span-2 xl:col-span-4">
            <label class="mb-2 ml-1 block text-xs font-bold uppercase tracking-widest text-slate-500">
                Location
            </label>
        ...
        <div class="group md:col-span-2 xl:col-span-4">
            ...
            <textarea name="description" rows="4" placeholder="Optional notes about this product..."
                class="w-full rounded-2xl border-2 border-slate-100 bg-slate-50 px-4 py-3.5 text-sm text-slate-900 placeholder:text-slate-400 focus:border-[#8b5cf6] focus:bg-white focus:ring-4 focus:ring-[#8b5cf6]/10">{{ old('description', $product->description ?? '') }}</textarea>
        </div>
    ...
    <div class="flex justify-end gap-3 pt-4">
        <a href="{{ route('products.index') }}"
            class="rounded-2xl px-6 py-3 text-sm font-bold text-slate-500 transition hover:bg-slate-100">
            Cancel
        </a>

        <button type="submit"
            class="rounded-2xl bg-[#8b5cf6] px-8 py-3 text-sm font-bold text-white transition hover:bg-[#7c3aed]">
            {{ $button ?? 'Save Product' }}
        </button>
    </div>
