    ...
    <div class="mx-auto max-w-4xl">
        ...
        <div class="mb-6 flex items-center justify-between">
            <nav class="flex items-center gap-2 text-sm font-medium">
                ...
                <span class="text-slate-900">Edit Supplier</span>
            </nav>
        ...
        <div class="overflow-hidden rounded-3xl border border-slate-100 bg-white shadow-xl shadow-slate-200/50">
            ...
            <div class="p-8 lg:p-10">
                ...
                <div class="mb-10 flex items-start justify-between">
                    <div>
                        ...
                        <p class="mt-2 text-slate-500">
                            Update supplier details, contact information, and procurement references.
                        </p>
                    </div>
                ...
                {{-- Form --}}
                <form action="{{ route('suppliers.update', $supplier) }}" method="POST" class="space-y-0">
                    @csrf
                    @method('PUT')
            ...
            <div class="border-t border-slate-100 bg-slate-50 px-8 py-4">
                <p class="flex items-center gap-2 text-xs text-slate-400">
                    ...
                    Changes will be reflected across all linked purchase and stock records.
                </p>
            </div>
