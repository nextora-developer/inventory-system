...
@section('content')
    <div class="overflow-hidden rounded-3xl border border-slate-100 bg-white shadow-sm">
        ...
        <div
            ...
            <div>
                <h2 class="text-lg font-bold text-slate-900 md:text-xl">Supplier Registry</h2>
                <p class="mt-1 text-xs text-slate-500 md:text-sm">Manage and monitor supplier relationships.</p>
            </div>
        ...
        <div class="block md:hidden">
                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <div class="min-w-0 flex-1">
                            <div class="flex items-start justify-between gap-3">
                                <div class="min-w-0">
                                    <p class="text-sm font-bold text-slate-900">{{ $supplier->name }}</p>
                            ...
                            <div class="mt-3 grid grid-cols-2 gap-3 text-xs">
                                <div class="rounded-2xl bg-slate-50 px-3 py-2">
                                    <p class="font-bold uppercase tracking-wide text-slate-400">Contact</p>
                                ...
                                <div class="rounded-2xl bg-slate-50 px-3 py-2">
                                    <p class="font-bold uppercase tracking-wide text-slate-400">Phone</p>
                                    <p class="mt-1 truncate text-slate-600">
                            ...
                            <div class="mt-3 flex items-center justify-end gap-2">
                                ...
                                <form action="{{ route('suppliers.destroy', $supplier) }}" method="POST"
                                    onsubmit="return confirm('Archive this supplier?')" class="inline">
                                    @csrf
                                    @method('DELETE')
            ...
            @empty
                <div class="px-6 py-16 text-center">
                    <p class="font-medium text-slate-500">No suppliers registered yet.</p>
                    <a href="{{ route('suppliers.create') }}"
