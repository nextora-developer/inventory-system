        ...
        <div class="border-b border-slate-100 p-6 bg-white">
            <div class="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                ...
                <div>
                    ...
                    <p class="mt-1 text-sm text-slate-500">Products that require immediate restocking attention.</p>
                </div>
            ...
            <table class="min-w-full divide-y divide-slate-100">
                ...
                <thead class="bg-slate-50/50">
                    <tr>
                        ...
                        <th class="px-6 py-4 text-left text-[11px] font-bold uppercase tracking-[0.15em] text-slate-400">Minimum</th>
                        <th class="px-6 py-4 text-left text-[11px] font-bold uppercase tracking-[0.15em] text-slate-400">Location</th>
                    </tr>
                </thead>
                        ...
                        <tr class="group transition-all hover:bg-rose-50/40">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center gap-3">
                                    ...
                                    {{-- Icon --}}
                                    <div class="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-rose-50 text-rose-500 group-hover:bg-rose-100 transition">
                        ...
                        <tr>
                            <td colspan="6" class="px-6 py-20 text-center">
                                <div class="flex flex-col items-center justify-center">
                                    ...
                                    <p class="text-slate-500 font-medium">No low stock products 🎉</p>
                                </div>
                            </td>
                        </tr>
                    @endforelse
